...
import static com.demo.global.router.Endpoint.*;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody RegisterRequest request) {
        return ResponseEntity.status(HttpStatusCode.valueOf(201)).body(authService.register(request));
    }
     ...
     *
     * @apiNote Để đảm bảo kết quả trả về rõ ràng, nên sử dụng <b>Postman</b> thay vì <b>Swagger</b>.<br>
